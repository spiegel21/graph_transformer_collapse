...
class GINModel(torch.nn.Module):
    def __init__(self, input_feature_dim, hidden_feature_dim,
        ...
        self.proj_layer = GINConv(nn, train_eps=False, eps=0.0, bias=use_bias)
        ...
        for i in range(self.L):
            ...
            conv = GINConv(nn, train_eps=False, eps=0.0, bias=use_bias)
        ...
        self.final_layer = GINConv(nn, train_eps=False, eps=0.0, bias=use_bias) # Projection from latent space                                                                                     
